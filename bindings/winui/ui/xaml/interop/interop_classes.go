...
// NotifyCollectionChangedEventArgs is the Microsoft.UI.Xaml.Interop.NotifyCollectionChangedEventArgs runtime class, surfaced through its
...
func NewNotifyCollectionChangedEventArgsWithAllParameters(action NotifyCollectionChangedAction, newItems *IBindableVector, oldItems *IBindableVector, newIndex int32, oldIndex int32) (*NotifyCollectionChangedEventArgs, error) {
	factoryUnknown, err := winrt.GetActivationFactory("Microsoft.UI.Xaml.Interop.NotifyCollectionChangedEventArgs", &IID_INotifyCollectionChangedEventArgsFactory)
	if err != nil {
		return nil, err
	}
